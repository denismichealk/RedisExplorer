        ...
        private void SetClientStats(IGrouping<string, KeyValuePair<string, string>> clientstats)
        {
            if (clientstats != null)
            {
                ...
                ClientStatistics = new ClientStats
                {
                    ...
                    //BiggestInputBuf = clientstatsdict["client_biggest_input_buf"] ?? "0",
                    //                   LongestOutputList = clientstatsdict["client_longest_output_list"] ?? "0",
                    BiggestInputBuf = clientstatsdict["client_recent_max_input_buffer"],
                    LongestOutputList = clientstatsdict["client_recent_max_output_buffer"],
